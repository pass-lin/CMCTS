...
class BWEvaluator(Evaluator):
    def __init__(
        ...
        self.full_dataset = bw_utils.load_blocksworld(
            config_file, domain_file, data_path
        )  # [{"goal": str, "init": str}]
    ...
    def eval_output(self, answer, output):
        ...
        correct = bw_utils.validate_plan(
            self.domain_file, answer["instance_file"], self.lm_plan_file
        )[0]
        return correct
